    ...
    theme: {
        ...
        extend: {
            ...
            textColor: {
                ...
                'bg-primary':         colors.fuchsia['100'],
                'bg-info':            colors.sky['100'],
                'bg-success':         colors.green['100'],
