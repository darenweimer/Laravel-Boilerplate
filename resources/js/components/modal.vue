    ...
    <teleport to="body">
        <transition leave-active-class="duration-150">
            <div v-show="show" class="fixed inset-0 z-[100] px-4 py-12 sm:py-24 overflow-y-auto" scroll-region>
                <transition enter-active-class="ease-out duration-300" enter-from-class="opacity-0" enter-to-class="opacity-100" leave-active-class="ease-in duration-150" leave-from-class="opacity-100" leave-to-class="opacity-0">
